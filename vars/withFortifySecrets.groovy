def call(String product, String environment, String fortifyVaultName, Closure block) {
  def fortifySecrets = [
  ...
  String theKeyVaultUrl = fortifyVaultName ? "https://${fortifyVaultName}.vault.azure.net" : "https://${product}-${environment}.vault.azure.net/"
